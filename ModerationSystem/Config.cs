namespace ModerationSystem
{
    ...
    public class Config : IConfig
    {
        ...
        public Exiled.API.Features.Broadcast MuteMessage { get; private set; } = new Broadcast("<size=30><color=red>You has been muted for </color><color=aqua>{duration}</color></size>\n<size=26><color=aqua>{reason}</color></size>", 10);
